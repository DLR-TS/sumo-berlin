...
def main():
    ...
    if not options.skipnet:
        subprocess.check_call([sumolib.checkBinary("netconvert"), "-c", "berlin.netccfg",
                               ...
                               "--keep-edges.by-type", "railway.light_rail|usage.main,railway.light_rail|service.siding,railway.light_rail|service.crossover,railway.rail|usage.main,railway.rail|service.siding,railway.rail|service.crossover,railway.construction|usage.main,railway.light_rail",
    ...
    subprocess.check_call([os.path.join(os.environ["SUMO_HOME"], "tools", "net", "cut_net.py"),
                           "-n", "tk/tk.net.xml.gz", "-j", "tk/Doerpfeldstr.geojson",
                           "-o", "tk/Doerpfeldstr_raw.net.xml.gz"])
    subprocess.check_call([sumolib.checkBinary("netconvert"), "-s", "tk/Doerpfeldstr_raw.net.xml.gz",
                           "--remove-edges.input-file", "tk/remove_edges.txt",
                           "-o", "tk/Doerpfeldstr_removed.net.xml.gz"])
    subprocess.check_call([sumolib.checkBinary("netconvert"), "-s", "../Doerpfeldstr/net.net.xml.gz",
                           "--keep-edges.input-file", "tk/keep_edges.txt",
                           "-o", "tk/Doerpfeldstr_keep.net.xml.gz"])
    subprocess.check_call([sumolib.checkBinary("netconvert"),
                           "-s", "tk/Doerpfeldstr_keep.net.xml.gz,tk/Doerpfeldstr_removed.net.xml.gz",
                           "-n", "tk/joined.nod.xml", "--junctions.join-reset", "--crossings.guess",
                           "-o", "tk/Doerpfeldstr_merged.net.xml.gz"])

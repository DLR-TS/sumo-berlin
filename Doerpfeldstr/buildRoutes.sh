...
# pedestrians
python $SUMO_HOME/tools/randomTrips.py -n Doerpfeldstr_edit.net.xml.gz --seed 42 --fringe-factor 1 --insertion-density 10 -r peds.rou.xml --vehicle-class pedestrian --prefix ped --pedestrians --max-distance 2000 --persontrip.walk-opposite-factor 0.8 --persontrip.modes public -a vtypes.xml,gtfs_pt_stops.add.xml,gtfs_pt_vehicles.add.xml

...
python $SUMO_HOME/tools/routeSampler.py -r cars.rou.xml -d telraam_car_data.xml,manual_car_data.xml -o cars_sampled.rou.xml --prefix car_ --mismatch-output mismatch_car.xml --timeline TGw2_PKW --merge-strategy ignore
...
# bikes
python $SUMO_HOME/tools/randomTrips.py -n Doerpfeldstr_edit.net.xml.gz --seed 42 --fringe-factor 10 -p 5  -r bikes.rou.xml -b 50400 -e 54000 --vehicle-class bicycle --vclass bicycle --prefix  bike --prefix "b" --lanes -l
...
# delivery
python $SUMO_HOME/tools/randomTrips.py -n Doerpfeldstr_edit.net.xml.gz --seed 42 --fringe-factor 8 -p 8  -r delivery.rou.xml -b 50400 -e 54000 --vehicle-class delivery --vclass delivery --prefix deliv --lanes -l --min-distance 300 --remove-loops -a preferences.xml
